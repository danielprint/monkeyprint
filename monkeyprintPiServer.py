...
class monkeyprintPiServer:
    ...
    #    statusUpdateId = GLib.timeout_add(10, self.pollPrinterStatus)
        ...
        #GLib.io_add_watch(self.socket.fileDescriptor, GLib.IO_IN, self.zmq_callback, self.socket.socket)
...
#        self.programSettings['Debug'].value = True
    ...
    #    printProcessUpdateId = GLib.timeout_add(10, self.updateSlicePrint)
